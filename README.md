...
[![App Status](https://argocd.euforic.io/api/badge?name=${{values.env}}-${{values.component_id}}&revision=true)](https://argocd.euforic.io/applications/${{values.env}}-${{values.component_id}})
...
<a href="https://github.com/euforicio/${{values.component_id}}/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=euforicio/${{values.component_id}}" />
</a>
